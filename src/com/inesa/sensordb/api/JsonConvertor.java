...
//        try(Reader reader = new InputStreamReader(JsonConvertor.class.getResourceAsStream("resource/jsonsample.json"), "UTF-8")){
//            Gson gson = new GsonBuilder().create();
//            SingleItem p = gson.fromJson(reader, SingleItem.class);
...
//        jsonstr_sub = gson.fromJson("\"abc\"", String.class);
    ...
    public void json2java(FileReader jsonfile) throws IOException {
        try{//(
            BufferedReader buf_reader = new BufferedReader(jsonfile);
//                Reader reader = new InputStreamReader(JsonToJava.class
//                    .getResourceAsStream("resource/jsonsample.json"), "UTF-8")){
//                    Gson gson = new GsonBuilder().create();
